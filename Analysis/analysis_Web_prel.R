...
#title_sel = tolower(c("perfect", "perfect duet (ed sheeran & beyoncÙÆ)", "perfect duet (feat. beyonc?)", "perfect symphony (feat. andrea bocelli)", "perfect duet (ed sheeran & beyonc?)"))
plot_trend(at_sel,title_sel)
...
#==> correatio ?ó¦ ? ?óÝ?  p(191?, 176, 178)
#--> ÊçÖð?? ø·??øË ä¹ ×ùùâ ý§ÛÎ
